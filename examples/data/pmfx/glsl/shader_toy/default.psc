...
void main()
{
	...
	//main body from /Users/alex.dixon/dev/pmtech/examples/assets/shaders/shader_toy.shp
	ps_output _output;
	
	_output.colour = sample_texture( tex0, _input.tex_coord.xy ) * float4( sin( _input.time * 0.01 ), 1.0, 1.0, 1.0 );
