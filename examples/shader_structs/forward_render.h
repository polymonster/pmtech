...
struct forward_lit_sdf_shadow_sdf_shadow_skinned
{
	float4 m_albedo;
	float m_roughness;
	float m_reflectivity;
...
struct forward_lit_sdf_shadow_sdf_shadow_instanced
{
	float4 m_albedo;
	float m_roughness;
	float m_reflectivity;
...
struct forward_lit_sdf_shadow_sdf_shadow_instanced_skinned
{
	float4 m_albedo;
	float m_roughness;
	float m_reflectivity;
...
struct forward_lit_sdf_shadow_sdf_shadow_uv_scale
{
	float4 m_albedo;
	float2 m_uv_scale;
	float m_roughness;
...
struct forward_lit_sdf_shadow_sdf_shadow_uv_scale_skinned
{
	float4 m_albedo;
	float2 m_uv_scale;
	float m_roughness;
...
struct forward_lit_sdf_shadow_sdf_shadow_uv_scale_instanced
{
	float4 m_albedo;
	float2 m_uv_scale;
	float m_roughness;
...
struct forward_lit_sdf_shadow_sdf_shadow_uv_scale_instanced_skinned
{
	float4 m_albedo;
	float2 m_uv_scale;
	float m_roughness;
...
struct forward_lit_sdf_shadow_sdf_shadow_sss
{
	float4 m_albedo;
	float m_roughness;
	float m_reflectivity;
...
struct forward_lit_sdf_shadow_sdf_shadow_sss_skinned
{
	float4 m_albedo;
	float m_roughness;
	float m_reflectivity;
...
struct forward_lit_sdf_shadow_sdf_shadow_sss_instanced
{
	float4 m_albedo;
	float m_roughness;
	float m_reflectivity;
...
struct forward_lit_sdf_shadow_sdf_shadow_sss_instanced_skinned
{
	float4 m_albedo;
	float m_roughness;
	float m_reflectivity;
...
struct forward_lit_sdf_shadow_sdf_shadow_sss_uv_scale
{
	float4 m_albedo;
	float2 m_uv_scale;
	float m_roughness;
...
struct forward_lit_sdf_shadow_sdf_shadow_sss_uv_scale_skinned
{
	float4 m_albedo;
	float2 m_uv_scale;
	float m_roughness;
...
struct forward_lit_sdf_shadow_sdf_shadow_sss_uv_scale_instanced
{
	float4 m_albedo;
	float2 m_uv_scale;
	float m_roughness;
...
struct forward_lit_sdf_shadow_sdf_shadow_sss_uv_scale_instanced_skinned
{
	float4 m_albedo;
	float2 m_uv_scale;
	float m_roughness;
