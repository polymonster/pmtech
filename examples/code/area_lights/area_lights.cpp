...
void example_setup(ecs::ecs_scene* scene, camera& cam)
{
    ...
    vec3f al_scales[] = {vec3f(10.0f, 1.0f, 10.0f), vec3f(10.0f, 1.0f, 10.0f), vec3f(10.0f, 1.0f, 10.0f)};

    vec3f al_trans[] = {vec3f(-25.0f, 20.0f, -20.0f), vec3f(0.0f, 20.0f, -30.0f), vec3f(25.0f, 20.0f, -20.0f)};
