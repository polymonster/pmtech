...
static render_handles s_render_handles;
...
void show_ui()
{
    sampler_states[0] = s_render_handles.sampler_linear_clamp;
    sampler_states[1] = s_render_handles.sampler_linear_wrap;
    sampler_states[2] = s_render_handles.sampler_point_clamp;
    sampler_states[3] = s_render_handles.sampler_point_wrap;
