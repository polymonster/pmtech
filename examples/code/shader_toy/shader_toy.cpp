...
void init_renderer()
{
    ...
    // viewport
    k_render_handles.vp = {0.0f, 0.0f, 1280.0f, 720.0f, 0.0f, 1.0f};
...
PEN_TRV pen::user_entry(void* params)
{
    ...
    while (1)
    {
        ...
        pen::renderer_set_scissor_rect(
            rect{k_render_handles.vp.x, k_render_handles.vp.y, k_render_handles.vp.width, k_render_handles.vp.height});
