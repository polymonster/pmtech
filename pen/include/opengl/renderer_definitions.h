...
enum vertex_format : s32
{
    ...
    PEN_FORMAT_R8G8B8A8_UNORM       = PACK_GL_FORMAT( GL_UNSIGNED_BYTE, 4 ),
    PEN_FORMAT_R8G8_UNORM           = PACK_GL_FORMAT( GL_UNSIGNED_BYTE, 3 ),
    PEN_FORMAT_R8_UNORM             = PACK_GL_FORMAT( GL_UNSIGNED_BYTE, 1 )
};
