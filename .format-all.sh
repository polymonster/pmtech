...
find source/pen/include -name '**.inl' -or -name '*.h' | xargs clang-format -style=file -i
find source/pen/source -name '**.cpp' -or -name '*.h' -or -name '*mm' -or -name '.c' | xargs clang-format -style=file -i
find source/put/include -name '**.inl' -or -name '*.h' | xargs clang-format -style=file -i
find source/put/source -name '**.cpp' -or -name '*.h' | xargs clang-format -style=file -i
