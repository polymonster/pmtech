...
inline void debug_show_icons()
{
    ...
    ICON_DEBUG(ICON_FA_ENVELOPE_O);
    ICON_DEBUG(ICON_FA_HEART);
    ICON_DEBUG(ICON_FA_STAR);
    ICON_DEBUG(ICON_FA_STAR_O);
    ICON_DEBUG(ICON_FA_USER);
    ICON_DEBUG(ICON_FA_FILM);
    ICON_DEBUG(ICON_FA_TH_LARGE);
    ICON_DEBUG(ICON_FA_TH);
    ICON_DEBUG(ICON_FA_TH_LIST);
    ICON_DEBUG(ICON_FA_CHECK);
    ICON_DEBUG(ICON_FA_TIMES);
    ICON_DEBUG(ICON_FA_SEARCH_PLUS);
    ICON_DEBUG(ICON_FA_SEARCH_MINUS);
    ICON_DEBUG(ICON_FA_POWER_OFF);
    ICON_DEBUG(ICON_FA_SIGNAL);
    ICON_DEBUG(ICON_FA_COG);
    ICON_DEBUG(ICON_FA_TRASH_O);
    ICON_DEBUG(ICON_FA_HOME);
    ICON_DEBUG(ICON_FA_FILE_O);
    ICON_DEBUG(ICON_FA_CLOCK_O);
    ICON_DEBUG(ICON_FA_ROAD);
    ICON_DEBUG(ICON_FA_DOWNLOAD);
    ICON_DEBUG(ICON_FA_ARROW_CIRCLE_O_DOWN);
    ICON_DEBUG(ICON_FA_ARROW_CIRCLE_O_UP);
    ICON_DEBUG(ICON_FA_INBOX);
    ICON_DEBUG(ICON_FA_PLAY_CIRCLE_O);
    ICON_DEBUG(ICON_FA_REPEAT);
    ICON_DEBUG(ICON_FA_REFRESH);
    ICON_DEBUG(ICON_FA_LIST_ALT);
    ICON_DEBUG(ICON_FA_LOCK);
    ICON_DEBUG(ICON_FA_FLAG);
    ICON_DEBUG(ICON_FA_HEADPHONES);
    ICON_DEBUG(ICON_FA_VOLUME_OFF);
    ICON_DEBUG(ICON_FA_VOLUME_DOWN);
    ICON_DEBUG(ICON_FA_VOLUME_UP);
    ICON_DEBUG(ICON_FA_QRCODE);
    ICON_DEBUG(ICON_FA_BARCODE);
    ICON_DEBUG(ICON_FA_TAG);
    ICON_DEBUG(ICON_FA_TAGS);
    ICON_DEBUG(ICON_FA_BOOK);
    ICON_DEBUG(ICON_FA_BOOKMARK);
    ICON_DEBUG(ICON_FA_PRINT);
    ICON_DEBUG(ICON_FA_CAMERA);
    ICON_DEBUG(ICON_FA_FONT);
    ICON_DEBUG(ICON_FA_BOLD);
    ICON_DEBUG(ICON_FA_ITALIC);
    ICON_DEBUG(ICON_FA_TEXT_HEIGHT);
    ICON_DEBUG(ICON_FA_TEXT_WIDTH);
    ICON_DEBUG(ICON_FA_ALIGN_LEFT);
    ICON_DEBUG(ICON_FA_ALIGN_CENTER);
    ICON_DEBUG(ICON_FA_ALIGN_RIGHT);
    ICON_DEBUG(ICON_FA_ALIGN_JUSTIFY);
    ICON_DEBUG(ICON_FA_LIST);
    ICON_DEBUG(ICON_FA_OUTDENT);
    ICON_DEBUG(ICON_FA_INDENT);
    ICON_DEBUG(ICON_FA_VIDEO_CAMERA);
    ICON_DEBUG(ICON_FA_PICTURE_O);
    ICON_DEBUG(ICON_FA_PENCIL);
    ICON_DEBUG(ICON_FA_MAP_MARKER);
    ICON_DEBUG(ICON_FA_ADJUST);
    ICON_DEBUG(ICON_FA_TINT);
    ICON_DEBUG(ICON_FA_PENCIL_SQUARE_O);
    ICON_DEBUG(ICON_FA_SHARE_SQUARE_O);
    ICON_DEBUG(ICON_FA_CHECK_SQUARE_O);
    ICON_DEBUG(ICON_FA_ARROWS);
    ICON_DEBUG(ICON_FA_STEP_BACKWARD);
    ICON_DEBUG(ICON_FA_FAST_BACKWARD);
    ICON_DEBUG(ICON_FA_BACKWARD);
    ICON_DEBUG(ICON_FA_PLAY);
    ICON_DEBUG(ICON_FA_PAUSE);
    ICON_DEBUG(ICON_FA_STOP);
    ICON_DEBUG(ICON_FA_FORWARD);
    ICON_DEBUG(ICON_FA_FAST_FORWARD);
    ICON_DEBUG(ICON_FA_STEP_FORWARD);
    ICON_DEBUG(ICON_FA_EJECT);
    ICON_DEBUG(ICON_FA_CHEVRON_LEFT);
    ICON_DEBUG(ICON_FA_CHEVRON_RIGHT);
    ICON_DEBUG(ICON_FA_PLUS_CIRCLE);
    ICON_DEBUG(ICON_FA_MINUS_CIRCLE);
    ICON_DEBUG(ICON_FA_TIMES_CIRCLE);
    ICON_DEBUG(ICON_FA_CHECK_CIRCLE);
    ICON_DEBUG(ICON_FA_QUESTION_CIRCLE);
    ICON_DEBUG(ICON_FA_INFO_CIRCLE);
    ICON_DEBUG(ICON_FA_CROSSHAIRS);
    ICON_DEBUG(ICON_FA_TIMES_CIRCLE_O);
    ICON_DEBUG(ICON_FA_CHECK_CIRCLE_O);
    ICON_DEBUG(ICON_FA_BAN);
    ICON_DEBUG(ICON_FA_ARROW_LEFT);
    ICON_DEBUG(ICON_FA_ARROW_RIGHT);
    ICON_DEBUG(ICON_FA_ARROW_UP);
    ICON_DEBUG(ICON_FA_ARROW_DOWN);
    ICON_DEBUG(ICON_FA_SHARE);
    ICON_DEBUG(ICON_FA_EXPAND);
    ICON_DEBUG(ICON_FA_COMPRESS);
    ICON_DEBUG(ICON_FA_PLUS);
    ICON_DEBUG(ICON_FA_MINUS);
    ICON_DEBUG(ICON_FA_ASTERISK);
    ICON_DEBUG(ICON_FA_EXCLAMATION_CIRCLE);
    ICON_DEBUG(ICON_FA_GIFT);
    ICON_DEBUG(ICON_FA_LEAF);
    ICON_DEBUG(ICON_FA_FIRE);
    ICON_DEBUG(ICON_FA_EYE);
    ICON_DEBUG(ICON_FA_EYE_SLASH);
    ICON_DEBUG(ICON_FA_EXCLAMATION_TRIANGLE);
    ICON_DEBUG(ICON_FA_PLANE);
    ICON_DEBUG(ICON_FA_CALENDAR);
    ICON_DEBUG(ICON_FA_RANDOM);
    ICON_DEBUG(ICON_FA_COMMENT);
    ICON_DEBUG(ICON_FA_MAGNET);
    ICON_DEBUG(ICON_FA_CHEVRON_UP);
    ICON_DEBUG(ICON_FA_CHEVRON_DOWN);
    ICON_DEBUG(ICON_FA_RETWEET);
    ICON_DEBUG(ICON_FA_SHOPPING_CART);
    ICON_DEBUG(ICON_FA_FOLDER);
    ICON_DEBUG(ICON_FA_FOLDER_OPEN);
    ICON_DEBUG(ICON_FA_ARROWS_V);
    ICON_DEBUG(ICON_FA_ARROWS_H);
    ICON_DEBUG(ICON_FA_BAR_CHART);
    ICON_DEBUG(ICON_FA_TWITTER_SQUARE);
    ICON_DEBUG(ICON_FA_FACEBOOK_SQUARE);
    ICON_DEBUG(ICON_FA_CAMERA_RETRO);
    ICON_DEBUG(ICON_FA_KEY);
    ICON_DEBUG(ICON_FA_COGS);
    ICON_DEBUG(ICON_FA_COMMENTS);
    ICON_DEBUG(ICON_FA_THUMBS_O_UP);
    ICON_DEBUG(ICON_FA_THUMBS_O_DOWN);
    ICON_DEBUG(ICON_FA_STAR_HALF);
    ICON_DEBUG(ICON_FA_HEART_O);
    ICON_DEBUG(ICON_FA_SIGN_OUT);
    ICON_DEBUG(ICON_FA_LINKEDIN_SQUARE);
    ICON_DEBUG(ICON_FA_THUMB_TACK);
    ICON_DEBUG(ICON_FA_EXTERNAL_LINK);
    ICON_DEBUG(ICON_FA_SIGN_IN);
    ICON_DEBUG(ICON_FA_TROPHY);
    ICON_DEBUG(ICON_FA_GITHUB_SQUARE);
    ICON_DEBUG(ICON_FA_UPLOAD);
    ICON_DEBUG(ICON_FA_LEMON_O);
    ICON_DEBUG(ICON_FA_PHONE);
    ICON_DEBUG(ICON_FA_SQUARE_O);
    ICON_DEBUG(ICON_FA_BOOKMARK_O);
    ICON_DEBUG(ICON_FA_PHONE_SQUARE);
    ICON_DEBUG(ICON_FA_TWITTER);
    ICON_DEBUG(ICON_FA_FACEBOOK);
    ICON_DEBUG(ICON_FA_GITHUB);
    ICON_DEBUG(ICON_FA_UNLOCK);
    ICON_DEBUG(ICON_FA_CREDIT_CARD);
    ICON_DEBUG(ICON_FA_RSS);
    ICON_DEBUG(ICON_FA_HDD_O);
    ICON_DEBUG(ICON_FA_BULLHORN);
    ICON_DEBUG(ICON_FA_BELL);
    ICON_DEBUG(ICON_FA_CERTIFICATE);
    ICON_DEBUG(ICON_FA_HAND_O_RIGHT);
    ICON_DEBUG(ICON_FA_HAND_O_LEFT);
    ICON_DEBUG(ICON_FA_HAND_O_UP);
    ICON_DEBUG(ICON_FA_HAND_O_DOWN);
    ICON_DEBUG(ICON_FA_ARROW_CIRCLE_LEFT);
    ICON_DEBUG(ICON_FA_ARROW_CIRCLE_RIGHT);
    ICON_DEBUG(ICON_FA_ARROW_CIRCLE_UP);
    ICON_DEBUG(ICON_FA_ARROW_CIRCLE_DOWN);
    ICON_DEBUG(ICON_FA_GLOBE);
    ICON_DEBUG(ICON_FA_WRENCH);
    ICON_DEBUG(ICON_FA_TASKS);
    ICON_DEBUG(ICON_FA_FILTER);
    ...
    ICON_DEBUG(ICON_FA_FLASK);
    ICON_DEBUG(ICON_FA_SCISSORS);
    ICON_DEBUG(ICON_FA_FILES_O);
    ICON_DEBUG(ICON_FA_PAPERCLIP);
    ICON_DEBUG(ICON_FA_FLOPPY_O);
    ICON_DEBUG(ICON_FA_SQUARE);
    ICON_DEBUG(ICON_FA_BARS);
    ICON_DEBUG(ICON_FA_LIST_UL);
    ICON_DEBUG(ICON_FA_LIST_OL);
    ICON_DEBUG(ICON_FA_STRIKETHROUGH);
    ICON_DEBUG(ICON_FA_UNDERLINE);
    ICON_DEBUG(ICON_FA_TABLE);
    ICON_DEBUG(ICON_FA_MAGIC);
    ICON_DEBUG(ICON_FA_TRUCK);
    ICON_DEBUG(ICON_FA_PINTEREST);
    ICON_DEBUG(ICON_FA_PINTEREST_SQUARE);
    ICON_DEBUG(ICON_FA_GOOGLE_PLUS_SQUARE);
    ICON_DEBUG(ICON_FA_GOOGLE_PLUS);
    ICON_DEBUG(ICON_FA_MONEY);
    ICON_DEBUG(ICON_FA_CARET_DOWN);
    ICON_DEBUG(ICON_FA_CARET_UP);
    ICON_DEBUG(ICON_FA_CARET_LEFT);
    ICON_DEBUG(ICON_FA_CARET_RIGHT);
    ICON_DEBUG(ICON_FA_COLUMNS);
    ICON_DEBUG(ICON_FA_SORT);
    ICON_DEBUG(ICON_FA_SORT_DESC);
    ICON_DEBUG(ICON_FA_SORT_ASC);
    ICON_DEBUG(ICON_FA_ENVELOPE);
    ICON_DEBUG(ICON_FA_LINKEDIN);
    ICON_DEBUG(ICON_FA_UNDO);
    ICON_DEBUG(ICON_FA_GAVEL);
    ICON_DEBUG(ICON_FA_TACHOMETER);
    ICON_DEBUG(ICON_FA_COMMENT_O);
    ICON_DEBUG(ICON_FA_COMMENTS_O);
    ICON_DEBUG(ICON_FA_BOLT);
    ICON_DEBUG(ICON_FA_SITEMAP);
    ICON_DEBUG(ICON_FA_UMBRELLA);
    ICON_DEBUG(ICON_FA_CLIPBOARD);
    ICON_DEBUG(ICON_FA_LIGHTBULB_O);
    ICON_DEBUG(ICON_FA_EXCHANGE);
    ICON_DEBUG(ICON_FA_CLOUD_DOWNLOAD);
    ICON_DEBUG(ICON_FA_CLOUD_UPLOAD);
    ICON_DEBUG(ICON_FA_USER_MD);
    ICON_DEBUG(ICON_FA_STETHOSCOPE);
    ICON_DEBUG(ICON_FA_SUITCASE);
    ICON_DEBUG(ICON_FA_BELL_O);
    ICON_DEBUG(ICON_FA_COFFEE);
    ICON_DEBUG(ICON_FA_CUTLERY);
    ICON_DEBUG(ICON_FA_FILE_TEXT_O);
    ICON_DEBUG(ICON_FA_BUILDING_O);
    ICON_DEBUG(ICON_FA_HOSPITAL_O);
    ICON_DEBUG(ICON_FA_AMBULANCE);
    ICON_DEBUG(ICON_FA_MEDKIT);
    ICON_DEBUG(ICON_FA_FIGHTER_JET);
    ICON_DEBUG(ICON_FA_BEER);
    ICON_DEBUG(ICON_FA_H_SQUARE);
    ICON_DEBUG(ICON_FA_PLUS_SQUARE);
    ICON_DEBUG(ICON_FA_ANGLE_DOUBLE_LEFT);
    ICON_DEBUG(ICON_FA_ANGLE_DOUBLE_RIGHT);
    ICON_DEBUG(ICON_FA_ANGLE_DOUBLE_UP);
    ICON_DEBUG(ICON_FA_ANGLE_DOUBLE_DOWN);
    ICON_DEBUG(ICON_FA_ANGLE_LEFT);
    ICON_DEBUG(ICON_FA_ANGLE_RIGHT);
    ICON_DEBUG(ICON_FA_ANGLE_UP);
    ICON_DEBUG(ICON_FA_ANGLE_DOWN);
    ICON_DEBUG(ICON_FA_DESKTOP);
    ICON_DEBUG(ICON_FA_LAPTOP);
    ICON_DEBUG(ICON_FA_TABLET);
    ICON_DEBUG(ICON_FA_MOBILE);
    ICON_DEBUG(ICON_FA_CIRCLE_O);
    ICON_DEBUG(ICON_FA_QUOTE_LEFT);
    ICON_DEBUG(ICON_FA_QUOTE_RIGHT);
    ICON_DEBUG(ICON_FA_SPINNER);
    ICON_DEBUG(ICON_FA_CIRCLE);
    ICON_DEBUG(ICON_FA_REPLY);
    ICON_DEBUG(ICON_FA_GITHUB_ALT);
    ICON_DEBUG(ICON_FA_FOLDER_O);
    ICON_DEBUG(ICON_FA_FOLDER_OPEN_O);
    ICON_DEBUG(ICON_FA_SMILE_O);
    ICON_DEBUG(ICON_FA_FROWN_O);
    ICON_DEBUG(ICON_FA_MEH_O);
    ICON_DEBUG(ICON_FA_GAMEPAD);
    ICON_DEBUG(ICON_FA_KEYBOARD_O);
    ICON_DEBUG(ICON_FA_FLAG_O);
    ICON_DEBUG(ICON_FA_FLAG_CHECKERED);
    ICON_DEBUG(ICON_FA_TERMINAL);
    ICON_DEBUG(ICON_FA_CODE);
    ICON_DEBUG(ICON_FA_REPLY_ALL);
    ICON_DEBUG(ICON_FA_STAR_HALF_O);
    ICON_DEBUG(ICON_FA_LOCATION_ARROW);
    ICON_DEBUG(ICON_FA_CROP);
    ICON_DEBUG(ICON_FA_CODE_FORK);
    ICON_DEBUG(ICON_FA_CHAIN_BROKEN);
    ICON_DEBUG(ICON_FA_QUESTION);
    ICON_DEBUG(ICON_FA_INFO);
    ICON_DEBUG(ICON_FA_EXCLAMATION);
    ICON_DEBUG(ICON_FA_SUPERSCRIPT);
    ICON_DEBUG(ICON_FA_SUBSCRIPT);
    ICON_DEBUG(ICON_FA_ERASER);
    ICON_DEBUG(ICON_FA_PUZZLE_PIECE);
    ICON_DEBUG(ICON_FA_MICROPHONE);
    ICON_DEBUG(ICON_FA_MICROPHONE_SLASH);
    ICON_DEBUG(ICON_FA_SHIELD);
    ICON_DEBUG(ICON_FA_CALENDAR_O);
    ICON_DEBUG(ICON_FA_FIRE_EXTINGUISHER);
    ICON_DEBUG(ICON_FA_ROCKET);
    ICON_DEBUG(ICON_FA_MAXCDN);
    ICON_DEBUG(ICON_FA_CHEVRON_CIRCLE_LEFT);
    ICON_DEBUG(ICON_FA_CHEVRON_CIRCLE_RIGHT);
    ICON_DEBUG(ICON_FA_CHEVRON_CIRCLE_UP);
    ICON_DEBUG(ICON_FA_CHEVRON_CIRCLE_DOWN);
    ICON_DEBUG(ICON_FA_HTML5);
    ICON_DEBUG(ICON_FA_CSS3);
    ICON_DEBUG(ICON_FA_ANCHOR);
    ICON_DEBUG(ICON_FA_UNLOCK_ALT);
    ICON_DEBUG(ICON_FA_BULLSEYE);
    ICON_DEBUG(ICON_FA_ELLIPSIS_H);
    ICON_DEBUG(ICON_FA_ELLIPSIS_V);
    ICON_DEBUG(ICON_FA_RSS_SQUARE);
    ICON_DEBUG(ICON_FA_PLAY_CIRCLE);
    ICON_DEBUG(ICON_FA_TICKET);
    ICON_DEBUG(ICON_FA_MINUS_SQUARE);
    ICON_DEBUG(ICON_FA_MINUS_SQUARE_O);
    ICON_DEBUG(ICON_FA_LEVEL_UP);
    ICON_DEBUG(ICON_FA_LEVEL_DOWN);
    ICON_DEBUG(ICON_FA_CHECK_SQUARE);
    ICON_DEBUG(ICON_FA_PENCIL_SQUARE);
    ICON_DEBUG(ICON_FA_EXTERNAL_LINK_SQUARE);
    ICON_DEBUG(ICON_FA_SHARE_SQUARE);
    ICON_DEBUG(ICON_FA_COMPASS);
    ICON_DEBUG(ICON_FA_CARET_SQUARE_O_DOWN);
    ICON_DEBUG(ICON_FA_CARET_SQUARE_O_UP);
    ICON_DEBUG(ICON_FA_CARET_SQUARE_O_RIGHT);
    ICON_DEBUG(ICON_FA_EUR);
    ICON_DEBUG(ICON_FA_GBP);
    ICON_DEBUG(ICON_FA_USD);
    ICON_DEBUG(ICON_FA_INR);
    ICON_DEBUG(ICON_FA_JPY);
    ICON_DEBUG(ICON_FA_RUB);
    ICON_DEBUG(ICON_FA_KRW);
    ICON_DEBUG(ICON_FA_BTC);
    ICON_DEBUG(ICON_FA_FILE);
    ICON_DEBUG(ICON_FA_FILE_TEXT);
    ICON_DEBUG(ICON_FA_SORT_ALPHA_ASC);
    ICON_DEBUG(ICON_FA_SORT_ALPHA_DESC);
    ICON_DEBUG(ICON_FA_SORT_AMOUNT_ASC);
    ICON_DEBUG(ICON_FA_SORT_AMOUNT_DESC);
    ICON_DEBUG(ICON_FA_SORT_NUMERIC_ASC);
    ICON_DEBUG(ICON_FA_SORT_NUMERIC_DESC);
    ICON_DEBUG(ICON_FA_THUMBS_UP);
    ICON_DEBUG(ICON_FA_THUMBS_DOWN);
    ICON_DEBUG(ICON_FA_YOUTUBE_SQUARE);
    ICON_DEBUG(ICON_FA_YOUTUBE);
    ICON_DEBUG(ICON_FA_XING);
    ICON_DEBUG(ICON_FA_XING_SQUARE);
    ICON_DEBUG(ICON_FA_YOUTUBE_PLAY);
    ICON_DEBUG(ICON_FA_DROPBOX);
    ICON_DEBUG(ICON_FA_STACK_OVERFLOW);
    ICON_DEBUG(ICON_FA_INSTAGRAM);
    ICON_DEBUG(ICON_FA_FLICKR);
    ICON_DEBUG(ICON_FA_ADN);
    ICON_DEBUG(ICON_FA_BITBUCKET);
    ICON_DEBUG(ICON_FA_BITBUCKET_SQUARE);
    ...
    ICON_DEBUG(ICON_FA_LONG_ARROW_RIGHT);
    ICON_DEBUG(ICON_FA_APPLE);
    ICON_DEBUG(ICON_FA_WINDOWS);
    ICON_DEBUG(ICON_FA_ANDROID);
    ICON_DEBUG(ICON_FA_LINUX);
    ICON_DEBUG(ICON_FA_DRIBBBLE);
    ICON_DEBUG(ICON_FA_SKYPE);
    ICON_DEBUG(ICON_FA_FOURSQUARE);
    ICON_DEBUG(ICON_FA_TRELLO);
    ICON_DEBUG(ICON_FA_FEMALE);
    ICON_DEBUG(ICON_FA_MALE);
    ICON_DEBUG(ICON_FA_GRATIPAY);
    ICON_DEBUG(ICON_FA_SUN_O);
    ICON_DEBUG(ICON_FA_MOON_O);
    ICON_DEBUG(ICON_FA_ARCHIVE);
    ICON_DEBUG(ICON_FA_BUG);
    ICON_DEBUG(ICON_FA_VK);
    ICON_DEBUG(ICON_FA_WEIBO);
    ICON_DEBUG(ICON_FA_RENREN);
    ICON_DEBUG(ICON_FA_PAGELINES);
    ICON_DEBUG(ICON_FA_STACK_EXCHANGE);
    ICON_DEBUG(ICON_FA_ARROW_CIRCLE_O_RIGHT);
    ICON_DEBUG(ICON_FA_ARROW_CIRCLE_O_LEFT);
    ICON_DEBUG(ICON_FA_CARET_SQUARE_O_LEFT);
    ICON_DEBUG(ICON_FA_DOT_CIRCLE_O);
    ICON_DEBUG(ICON_FA_WHEELCHAIR);
    ICON_DEBUG(ICON_FA_VIMEO_SQUARE);
    ICON_DEBUG(ICON_FA_TRY);
    ICON_DEBUG(ICON_FA_PLUS_SQUARE_O);
    ICON_DEBUG(ICON_FA_SPACE_SHUTTLE);
    ICON_DEBUG(ICON_FA_SLACK);
    ICON_DEBUG(ICON_FA_ENVELOPE_SQUARE);
    ICON_DEBUG(ICON_FA_WORDPRESS);
    ICON_DEBUG(ICON_FA_OPENID);
    ICON_DEBUG(ICON_FA_UNIVERSITY);
    ICON_DEBUG(ICON_FA_GRADUATION_CAP);
    ICON_DEBUG(ICON_FA_YAHOO);
    ICON_DEBUG(ICON_FA_GOOGLE);
    ICON_DEBUG(ICON_FA_REDDIT);
    ICON_DEBUG(ICON_FA_REDDIT_SQUARE);
    ICON_DEBUG(ICON_FA_STUMBLEUPON_CIRCLE);
    ICON_DEBUG(ICON_FA_STUMBLEUPON);
    ICON_DEBUG(ICON_FA_DELICIOUS);
    ICON_DEBUG(ICON_FA_DIGG);
    ICON_DEBUG(ICON_FA_PIED_PIPER_PP);
    ICON_DEBUG(ICON_FA_PIED_PIPER_ALT);
    ICON_DEBUG(ICON_FA_DRUPAL);
    ICON_DEBUG(ICON_FA_JOOMLA);
    ICON_DEBUG(ICON_FA_LANGUAGE);
    ICON_DEBUG(ICON_FA_FAX);
    ICON_DEBUG(ICON_FA_BUILDING);
    ICON_DEBUG(ICON_FA_CHILD);
    ICON_DEBUG(ICON_FA_PAW);
    ICON_DEBUG(ICON_FA_SPOON);
    ICON_DEBUG(ICON_FA_CUBE);
    ICON_DEBUG(ICON_FA_CUBES);
    ICON_DEBUG(ICON_FA_BEHANCE);
    ICON_DEBUG(ICON_FA_BEHANCE_SQUARE);
    ICON_DEBUG(ICON_FA_STEAM);
    ICON_DEBUG(ICON_FA_STEAM_SQUARE);
    ICON_DEBUG(ICON_FA_RECYCLE);
    ICON_DEBUG(ICON_FA_CAR);
    ICON_DEBUG(ICON_FA_TAXI);
    ICON_DEBUG(ICON_FA_TREE);
    ICON_DEBUG(ICON_FA_SPOTIFY);
    ICON_DEBUG(ICON_FA_DEVIANTART);
    ICON_DEBUG(ICON_FA_SOUNDCLOUD);
    ICON_DEBUG(ICON_FA_DATABASE);
    ICON_DEBUG(ICON_FA_FILE_PDF_O);
    ICON_DEBUG(ICON_FA_FILE_WORD_O);
    ICON_DEBUG(ICON_FA_FILE_EXCEL_O);
    ICON_DEBUG(ICON_FA_FILE_POWERPOINT_O);
    ICON_DEBUG(ICON_FA_FILE_IMAGE_O);
    ICON_DEBUG(ICON_FA_FILE_ARCHIVE_O);
    ICON_DEBUG(ICON_FA_FILE_AUDIO_O);
    ICON_DEBUG(ICON_FA_FILE_VIDEO_O);
    ICON_DEBUG(ICON_FA_FILE_CODE_O);
    ICON_DEBUG(ICON_FA_VINE);
    ICON_DEBUG(ICON_FA_CODEPEN);
    ICON_DEBUG(ICON_FA_JSFIDDLE);
    ICON_DEBUG(ICON_FA_LIFE_RING);
    ICON_DEBUG(ICON_FA_CIRCLE_O_NOTCH);
    ICON_DEBUG(ICON_FA_REBEL);
    ICON_DEBUG(ICON_FA_EMPIRE);
    ICON_DEBUG(ICON_FA_GIT_SQUARE);
    ICON_DEBUG(ICON_FA_GIT);
    ICON_DEBUG(ICON_FA_HACKER_NEWS);
    ICON_DEBUG(ICON_FA_TENCENT_WEIBO);
    ICON_DEBUG(ICON_FA_QQ);
    ICON_DEBUG(ICON_FA_WEIXIN);
    ICON_DEBUG(ICON_FA_PAPER_PLANE);
    ICON_DEBUG(ICON_FA_PAPER_PLANE_O);
    ICON_DEBUG(ICON_FA_HISTORY);
    ICON_DEBUG(ICON_FA_CIRCLE_THIN);
    ICON_DEBUG(ICON_FA_HEADER);
    ICON_DEBUG(ICON_FA_PARAGRAPH);
    ICON_DEBUG(ICON_FA_SLIDERS);
    ICON_DEBUG(ICON_FA_SHARE_ALT);
    ICON_DEBUG(ICON_FA_SHARE_ALT_SQUARE);
    ICON_DEBUG(ICON_FA_BOMB);
    ICON_DEBUG(ICON_FA_FUTBOL_O);
    ICON_DEBUG(ICON_FA_TTY);
    ICON_DEBUG(ICON_FA_BINOCULARS);
    ICON_DEBUG(ICON_FA_PLUG);
    ICON_DEBUG(ICON_FA_SLIDESHARE);
    ICON_DEBUG(ICON_FA_TWITCH);
    ICON_DEBUG(ICON_FA_YELP);
    ICON_DEBUG(ICON_FA_NEWSPAPER_O);
    ICON_DEBUG(ICON_FA_WIFI);
    ICON_DEBUG(ICON_FA_CALCULATOR);
    ICON_DEBUG(ICON_FA_PAYPAL);
    ICON_DEBUG(ICON_FA_GOOGLE_WALLET);
    ICON_DEBUG(ICON_FA_CC_VISA);
    ICON_DEBUG(ICON_FA_CC_MASTERCARD);
    ICON_DEBUG(ICON_FA_CC_DISCOVER);
    ICON_DEBUG(ICON_FA_CC_AMEX);
    ICON_DEBUG(ICON_FA_CC_PAYPAL);
    ICON_DEBUG(ICON_FA_CC_STRIPE);
    ICON_DEBUG(ICON_FA_BELL_SLASH);
    ICON_DEBUG(ICON_FA_BELL_SLASH_O);
    ICON_DEBUG(ICON_FA_TRASH);
    ICON_DEBUG(ICON_FA_COPYRIGHT);
    ICON_DEBUG(ICON_FA_AT);
    ICON_DEBUG(ICON_FA_EYEDROPPER);
    ICON_DEBUG(ICON_FA_PAINT_BRUSH);
    ICON_DEBUG(ICON_FA_BIRTHDAY_CAKE);
    ICON_DEBUG(ICON_FA_AREA_CHART);
    ICON_DEBUG(ICON_FA_PIE_CHART);
    ICON_DEBUG(ICON_FA_LINE_CHART);
    ICON_DEBUG(ICON_FA_LASTFM);
    ICON_DEBUG(ICON_FA_LASTFM_SQUARE);
    ICON_DEBUG(ICON_FA_TOGGLE_OFF);
    ICON_DEBUG(ICON_FA_TOGGLE_ON);
    ICON_DEBUG(ICON_FA_BICYCLE);
    ICON_DEBUG(ICON_FA_BUS);
    ICON_DEBUG(ICON_FA_IOXHOST);
    ICON_DEBUG(ICON_FA_ANGELLIST);
    ICON_DEBUG(ICON_FA_CC);
    ICON_DEBUG(ICON_FA_ILS);
    ICON_DEBUG(ICON_FA_MEANPATH);
    ICON_DEBUG(ICON_FA_BUYSELLADS);
    ICON_DEBUG(ICON_FA_CONNECTDEVELOP);
    ICON_DEBUG(ICON_FA_DASHCUBE);
    ICON_DEBUG(ICON_FA_FORUMBEE);
    ICON_DEBUG(ICON_FA_LEANPUB);
    ICON_DEBUG(ICON_FA_SELLSY);
    ICON_DEBUG(ICON_FA_SHIRTSINBULK);
    ICON_DEBUG(ICON_FA_SIMPLYBUILT);
    ICON_DEBUG(ICON_FA_SKYATLAS);
    ICON_DEBUG(ICON_FA_CART_PLUS);
    ICON_DEBUG(ICON_FA_CART_ARROW_DOWN);
    ICON_DEBUG(ICON_FA_DIAMOND);
    ICON_DEBUG(ICON_FA_SHIP);
    ICON_DEBUG(ICON_FA_USER_SECRET);
    ICON_DEBUG(ICON_FA_MOTORCYCLE);
    ICON_DEBUG(ICON_FA_STREET_VIEW);
    ICON_DEBUG(ICON_FA_HEARTBEAT);
    ICON_DEBUG(ICON_FA_VENUS);
    ICON_DEBUG(ICON_FA_MARS);
    ICON_DEBUG(ICON_FA_MERCURY);
    ICON_DEBUG(ICON_FA_TRANSGENDER);
    ICON_DEBUG(ICON_FA_TRANSGENDER_ALT);
    ICON_DEBUG(ICON_FA_VENUS_DOUBLE);
    ...
    ICON_DEBUG(ICON_FA_NEUTER);
    ICON_DEBUG(ICON_FA_GENDERLESS);
    ICON_DEBUG(ICON_FA_FACEBOOK_OFFICIAL);
    ICON_DEBUG(ICON_FA_PINTEREST_P);
    ICON_DEBUG(ICON_FA_WHATSAPP);
    ICON_DEBUG(ICON_FA_SERVER);
    ICON_DEBUG(ICON_FA_USER_PLUS);
    ICON_DEBUG(ICON_FA_USER_TIMES);
    ICON_DEBUG(ICON_FA_BED);
    ICON_DEBUG(ICON_FA_VIACOIN);
    ICON_DEBUG(ICON_FA_TRAIN);
    ICON_DEBUG(ICON_FA_SUBWAY);
    ICON_DEBUG(ICON_FA_MEDIUM);
    ICON_DEBUG(ICON_FA_Y_COMBINATOR);
    ICON_DEBUG(ICON_FA_OPTIN_MONSTER);
    ICON_DEBUG(ICON_FA_OPENCART);
    ICON_DEBUG(ICON_FA_EXPEDITEDSSL);
    ICON_DEBUG(ICON_FA_BATTERY_FULL);
    ICON_DEBUG(ICON_FA_BATTERY_THREE_QUARTERS);
    ICON_DEBUG(ICON_FA_BATTERY_HALF);
    ICON_DEBUG(ICON_FA_BATTERY_QUARTER);
    ICON_DEBUG(ICON_FA_BATTERY_EMPTY);
    ICON_DEBUG(ICON_FA_MOUSE_POINTER);
    ICON_DEBUG(ICON_FA_I_CURSOR);
    ICON_DEBUG(ICON_FA_OBJECT_GROUP);
    ICON_DEBUG(ICON_FA_OBJECT_UNGROUP);
    ICON_DEBUG(ICON_FA_STICKY_NOTE);
    ICON_DEBUG(ICON_FA_STICKY_NOTE_O);
    ICON_DEBUG(ICON_FA_CC_JCB);
    ICON_DEBUG(ICON_FA_CC_DINERS_CLUB);
    ICON_DEBUG(ICON_FA_CLONE);
    ICON_DEBUG(ICON_FA_BALANCE_SCALE);
    ICON_DEBUG(ICON_FA_HOURGLASS_O);
    ICON_DEBUG(ICON_FA_HOURGLASS_START);
    ICON_DEBUG(ICON_FA_HOURGLASS_HALF);
    ICON_DEBUG(ICON_FA_HOURGLASS_END);
    ICON_DEBUG(ICON_FA_HOURGLASS);
    ICON_DEBUG(ICON_FA_HAND_ROCK_O);
    ICON_DEBUG(ICON_FA_HAND_PAPER_O);
    ICON_DEBUG(ICON_FA_HAND_SCISSORS_O);
    ICON_DEBUG(ICON_FA_HAND_LIZARD_O);
    ICON_DEBUG(ICON_FA_HAND_SPOCK_O);
    ICON_DEBUG(ICON_FA_HAND_POINTER_O);
    ICON_DEBUG(ICON_FA_HAND_PEACE_O);
    ICON_DEBUG(ICON_FA_TRADEMARK);
    ICON_DEBUG(ICON_FA_REGISTERED);
    ICON_DEBUG(ICON_FA_CREATIVE_COMMONS);
    ICON_DEBUG(ICON_FA_GG);
    ICON_DEBUG(ICON_FA_GG_CIRCLE);
    ICON_DEBUG(ICON_FA_TRIPADVISOR);
    ICON_DEBUG(ICON_FA_ODNOKLASSNIKI);
    ICON_DEBUG(ICON_FA_ODNOKLASSNIKI_SQUARE);
    ICON_DEBUG(ICON_FA_GET_POCKET);
    ICON_DEBUG(ICON_FA_WIKIPEDIA_W);
    ICON_DEBUG(ICON_FA_SAFARI);
    ICON_DEBUG(ICON_FA_CHROME);
    ICON_DEBUG(ICON_FA_FIREFOX);
    ICON_DEBUG(ICON_FA_OPERA);
    ICON_DEBUG(ICON_FA_INTERNET_EXPLORER);
    ICON_DEBUG(ICON_FA_TELEVISION);
    ICON_DEBUG(ICON_FA_CONTAO);
    ICON_DEBUG(ICON_FA_500PX);
    ICON_DEBUG(ICON_FA_AMAZON);
    ICON_DEBUG(ICON_FA_CALENDAR_PLUS_O);
    ICON_DEBUG(ICON_FA_CALENDAR_MINUS_O);
    ICON_DEBUG(ICON_FA_CALENDAR_TIMES_O);
    ICON_DEBUG(ICON_FA_CALENDAR_CHECK_O);
    ICON_DEBUG(ICON_FA_INDUSTRY);
    ICON_DEBUG(ICON_FA_MAP_PIN);
    ICON_DEBUG(ICON_FA_MAP_SIGNS);
    ICON_DEBUG(ICON_FA_MAP_O);
    ICON_DEBUG(ICON_FA_MAP);
    ICON_DEBUG(ICON_FA_COMMENTING);
    ICON_DEBUG(ICON_FA_COMMENTING_O);
    ICON_DEBUG(ICON_FA_HOUZZ);
    ICON_DEBUG(ICON_FA_VIMEO);
    ICON_DEBUG(ICON_FA_BLACK_TIE);
    ICON_DEBUG(ICON_FA_FONTICONS);
    ICON_DEBUG(ICON_FA_REDDIT_ALIEN);
    ICON_DEBUG(ICON_FA_EDGE);
    ICON_DEBUG(ICON_FA_CREDIT_CARD_ALT);
    ICON_DEBUG(ICON_FA_CODIEPIE);
    ICON_DEBUG(ICON_FA_MODX);
    ICON_DEBUG(ICON_FA_FORT_AWESOME);
    ICON_DEBUG(ICON_FA_USB);
    ICON_DEBUG(ICON_FA_PRODUCT_HUNT);
    ICON_DEBUG(ICON_FA_MIXCLOUD);
    ICON_DEBUG(ICON_FA_SCRIBD);
    ICON_DEBUG(ICON_FA_PAUSE_CIRCLE);
    ICON_DEBUG(ICON_FA_PAUSE_CIRCLE_O);
    ICON_DEBUG(ICON_FA_STOP_CIRCLE);
    ICON_DEBUG(ICON_FA_STOP_CIRCLE_O);
    ICON_DEBUG(ICON_FA_SHOPPING_BAG);
    ICON_DEBUG(ICON_FA_SHOPPING_BASKET);
    ICON_DEBUG(ICON_FA_HASHTAG);
    ICON_DEBUG(ICON_FA_BLUETOOTH);
    ICON_DEBUG(ICON_FA_BLUETOOTH_B);
    ICON_DEBUG(ICON_FA_PERCENT);
    ICON_DEBUG(ICON_FA_GITLAB);
    ICON_DEBUG(ICON_FA_WPBEGINNER);
    ICON_DEBUG(ICON_FA_WPFORMS);
    ICON_DEBUG(ICON_FA_ENVIRA);
    ICON_DEBUG(ICON_FA_UNIVERSAL_ACCESS);
    ICON_DEBUG(ICON_FA_WHEELCHAIR_ALT);
    ICON_DEBUG(ICON_FA_QUESTION_CIRCLE_O);
    ICON_DEBUG(ICON_FA_BLIND);
    ICON_DEBUG(ICON_FA_AUDIO_DESCRIPTION);
    ICON_DEBUG(ICON_FA_VOLUME_CONTROL_PHONE);
    ICON_DEBUG(ICON_FA_BRAILLE);
    ICON_DEBUG(ICON_FA_ASSISTIVE_LISTENING_SYSTEMS);
    ICON_DEBUG(ICON_FA_AMERICAN_SIGN_LANGUAGE_INTERPRETING);
    ICON_DEBUG(ICON_FA_DEAF);
    ICON_DEBUG(ICON_FA_GLIDE);
    ICON_DEBUG(ICON_FA_GLIDE_G);
    ICON_DEBUG(ICON_FA_SIGN_LANGUAGE);
    ICON_DEBUG(ICON_FA_LOW_VISION);
    ICON_DEBUG(ICON_FA_VIADEO);
    ICON_DEBUG(ICON_FA_VIADEO_SQUARE);
    ICON_DEBUG(ICON_FA_SNAPCHAT);
    ICON_DEBUG(ICON_FA_SNAPCHAT_GHOST);
    ICON_DEBUG(ICON_FA_SNAPCHAT_SQUARE);
    ICON_DEBUG(ICON_FA_PIED_PIPER);
    ICON_DEBUG(ICON_FA_FIRST_ORDER);
    ICON_DEBUG(ICON_FA_YOAST);
    ICON_DEBUG(ICON_FA_THEMEISLE);
    ICON_DEBUG(ICON_FA_GOOGLE_PLUS_OFFICIAL);
    ICON_DEBUG(ICON_FA_FONT_AWESOME);
    ICON_DEBUG(ICON_FA_HANDSHAKE_O);
    ICON_DEBUG(ICON_FA_ENVELOPE_OPEN);
    ICON_DEBUG(ICON_FA_ENVELOPE_OPEN_O);
    ICON_DEBUG(ICON_FA_LINODE);
    ICON_DEBUG(ICON_FA_ADDRESS_BOOK);
    ICON_DEBUG(ICON_FA_ADDRESS_BOOK_O);
    ICON_DEBUG(ICON_FA_ADDRESS_CARD);
    ICON_DEBUG(ICON_FA_ADDRESS_CARD_O);
    ICON_DEBUG(ICON_FA_USER_CIRCLE);
    ICON_DEBUG(ICON_FA_USER_CIRCLE_O);
    ICON_DEBUG(ICON_FA_USER_O);
    ICON_DEBUG(ICON_FA_ID_BADGE);
    ICON_DEBUG(ICON_FA_ID_CARD);
    ICON_DEBUG(ICON_FA_ID_CARD_O);
    ICON_DEBUG(ICON_FA_QUORA);
    ICON_DEBUG(ICON_FA_FREE_CODE_CAMP);
    ICON_DEBUG(ICON_FA_TELEGRAM);
    ICON_DEBUG(ICON_FA_THERMOMETER_FULL);
    ICON_DEBUG(ICON_FA_THERMOMETER_THREE_QUARTERS);
    ICON_DEBUG(ICON_FA_THERMOMETER_HALF);
    ICON_DEBUG(ICON_FA_THERMOMETER_QUARTER);
    ICON_DEBUG(ICON_FA_THERMOMETER_EMPTY);
    ICON_DEBUG(ICON_FA_SHOWER);
    ICON_DEBUG(ICON_FA_BATH);
    ICON_DEBUG(ICON_FA_PODCAST);
    ICON_DEBUG(ICON_FA_WINDOW_MAXIMIZE);
    ICON_DEBUG(ICON_FA_WINDOW_MINIMIZE);
    ICON_DEBUG(ICON_FA_WINDOW_RESTORE);
    ICON_DEBUG(ICON_FA_WINDOW_CLOSE);
    ICON_DEBUG(ICON_FA_WINDOW_CLOSE_O);
    ICON_DEBUG(ICON_FA_BANDCAMP);
    ICON_DEBUG(ICON_FA_GRAV);
    ICON_DEBUG(ICON_FA_ETSY);
    ICON_DEBUG(ICON_FA_IMDB);
    ICON_DEBUG(ICON_FA_RAVELRY);
    ICON_DEBUG(ICON_FA_EERCAST);
    ICON_DEBUG(ICON_FA_MICROCHIP);
    ICON_DEBUG(ICON_FA_SNOWFLAKE_O);
